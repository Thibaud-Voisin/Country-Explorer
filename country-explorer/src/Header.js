...
const Header = ({theme, toggle_theme, isVisibleAlert }) => {
    useEffect(() => {
        // Function to print the value whenever it changes
...
<header className='header w-full'>
  ...
  <ul className="m-2 menu menu-horizontal bg-base-200 rounded-box">
  <li className='m-1'>
  <label className="h-12 w-12 fill-white swap swap-rotate">
      <svg onClick={scroll_up} xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke={theme === 'dark' ? 'white':'black'}><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" /></svg>
    </label>
  </li>
  <li className='m-1'>
  <label className={`h-12 w-12 swap swap-rotate fill-white ${theme === 'dark' ? 'fill-white':'fill-black'}`}>
    <input type="checkbox" className="thedme-controller" onClick={toggle_theme} />
